...
#include "../debug_backup/debug_batt_swire.h"
...
//
//*****************************************************************************
DebugBattSwire::DebugBattSwire(unsigned char ucID, Widget *pParent)
...
//****************************************************************************
void
DebugBattSwire::ACQMBDebugDraw(tContext *pContext)
{
	char pcString[17];
	long lColumn = 0;
	long lX;
...
//****************************************************************************
void
DebugBattSwire::APSDebugDraw(tContext *pContext)
{
	char pcString[17];
	long lColumn = 0;
	long lX;
...
//****************************************************************************
void
DebugBattSwire::BattShuntDebugDraw(tContext *pContext)
{
	char pcString[17];
	long lColumn = 0;
	long lX;
...
//*****************************************************************************
long
DebugBattSwire::MessageProc(unsigned long ulMsg, unsigned long ulParam1,
...
//
//*****************************************************************************
DebugBattSwire::~DebugBattSwire(void)
{
