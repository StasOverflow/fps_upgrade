...
#ifndef DEBUG_SYSTEM_HORIZONTAL_H_
#define DEBUG_SYSTEM_HORIZONTAL_H_
...
//
//*****************************************************************************
class DebugSystemHorizontal : public Widget
{
public:
    DebugSystemHorizontal(unsigned char ucID, Widget *pParent);
...
#endif /* DEBUG_SYSTEM_HORIZONTAL_H_ */
